...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        inputsPanel.setBackground(new java.awt.Color(153, 153, 255));
        ...
        jTextField1.setText("Vadym Drahanov");
        jTextField1.setToolTipText("Enter login name");
        ...
        jCheckBox1.setFont(new java.awt.Font("Apple Braille", 1, 12)); // NOI18N
        jCheckBox1.setForeground(new java.awt.Color(255, 255, 255));
        jCheckBox1.setText("Remember me");

        jLabel4.setFont(new java.awt.Font("Apple Braille", 1, 12)); // NOI18N
